...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,jQuery,UI,Next,Var,_3nyildarts,Client,Var1,Unchecked,List,T,Doc,View1,AttrProxy,AttrModule,Arrays,Seq,ListModel,Strings;
 Runtime.Define(Global,{
  _3nyildarts:{
   Client:{
    Main:Runtime.Field(function()
    {
     var newName,Add,ListContainer;
     jQuery("#main").empty();
     newName=Var.Create("");
     Add=function()
     {
      return function()
      {
       var A,Result;
       Client.Res2().Clear();
       A=Client.create(Var1.Get(newName)<<0,Client.Map());
       if(Unchecked.Equals(A,Runtime.New(T,{
        $:0
       })))
        {
         Result=List.ofArray(["Nem lehetseges"]);
         Client.Res2().Set(Result);
     ...
     },Client.Res2().get_View())]);
     return Doc.RunById("main",Doc.Concat([Doc.TextNode("\n        "),Doc.Element("div",[],[Doc.TextNode("\n            "),Doc.Input([AttrProxy.Create("placeholder","Dobas 1-180 kozott")],newName),Doc.TextNode("\n            "),Doc.Element("button",[AttrModule.Handler("click",Add)],[Doc.TextNode("Give me the results!")]),Doc.TextNode("\n        ")]),Doc.TextNode("\n        "),Doc.Element("ul",[],Arrays.ofSeq(ListContainer)),Doc.TextNode("\n    ")]));
    }),
    Map:Runtime.Field(function()
    {
     var list;
     list=List.ofArray([[1,List.ofArray(["1"])],[2,List.ofArray(["2","D1"])],[3,List.ofArray(["3"])],[4,List.ofArray(["D2","4"])],[5,List.ofArray(["5"])],[6,List.ofArray(["6","D3","T2"])],[7,List.ofArray(["7"])],[8,List.ofArray(["D4","8"])],[9,List.ofArray(["9"])],[10,List.ofArray(["10","D5"])],[11,List.ofArray(["11"])],[12,List.ofArray(["D6","12","T4"])],[13,List.ofArray(["13"])],[14,List.ofArray(["14","D7"])],[15,List.ofArray(["15","T3"])],[16,List.ofArray(["D8","16"])],[17,List.ofArray(["17"])],[18,List.ofArray(["18","D9"])],[19,List.ofArray(["3"])],[20,List.ofArray(["D10","20"])],[21,List.ofArray(["T7"])],[22,List.ofArray(["D11"])],[24,List.ofArray(["D12","24"])],[25,List.ofArray(["25"])],[26,List.ofArray(["D13"])],[27,List.ofArray(["T9"])],[28,List.ofArray(["D14"])],[30,List.ofArray(["D15"])],[32,List.ofArray(["D16"])],[34,List.ofArray(["D17"])],[36,List.ofArray(["D18","T12"])],[38,List.ofArray(["D19"])],[40,List.ofArray(["D20"])],[42,List.ofArray(["T14"])],[45,List.ofArray(["T15"])],[48,List.ofArray(["T16"])],[50,List.ofArray(["D25"])],[51,List.ofArray(["T17"])],[54,List.ofArray(["T18"])],[57,List.ofArray(["T19"])],[60,List.ofArray(["T20"])]]);
     return List.rev(list);
    }),
    Res2:Runtime.Field(function()
    {
     var arg00;
     arg00=Seq.empty();
     return ListModel.FromSeq(arg00);
    }),
    cartesian:function(lstlst)
    {
     var _,_1,h,h1,t;
     if(lstlst.$==1)
      {
       if(lstlst.$1.$==0)
       ...
       else
        {
         h1=lstlst.$0;
         t=lstlst.$1;
         _1=Seq.fold(function(cacc)
         {
          return function(celem)
          {
           return List.append(Seq.fold(function(acc)
           {
            return function(elem)
            {
             return Runtime.New(T,{
       ...
       if(t<0)
       ...
       else
        {
         if(t>180)
          ...
          {
           Q=t-hd[0];
           _2=List.append(Client.seged(Q,l,hd[1],hd[0]),Client.create(t,tl));
          }
         _1=_2;
        }
       _=_1;
    ...
    seged:function(t,l,ls,p)
    {
     var _,_1,_2,tl,hd,_3,Q;
     if(t===0)
      {
       _=ls;
      }
         ...
         if(l.$==1)
          {
           ...
           if(hd[0]<=p)
            {
             Q=t-hd[0];
             _3=List.append(Client.seged2(Q,l,ls,hd[1],hd[0]),Client.seged(t,tl,ls,p));
            }
           else
            {
             _3=Runtime.New(T,{
    ...
    seged2:function(t,l,ls,lt,p)
    {
     var _,E,_1,_2,tl,hd,_3,Q;
     if(t===0)
      {
       E=List.ofArray([ls,lt]);
       _=List.map(function(x)
       {
        return Strings.concat(" - ",x);
       },Client.cartesian(E));
      }
     else
      {
         ...
         if(l.$==1)
          {
           ...
           if(hd[0]<=p)
            {
             Q=t-hd[0];
             _3=List.append(Client.seged3(Q,l,ls,lt,hd[1],hd[0]),Client.seged2(t,tl,ls,lt,p));
            }
           else
            {
             _3=Runtime.New(T,{
    ...
    seged3:function(t,l,ls,lt,lu)
    {
     var _,E;
     if(t===0)
      {
       E=List.ofArray([ls,lt,lu]);
       _=List.map(function(x)
       {
        return Strings.concat(" - ",x);
       },Client.cartesian(E));
 ...
 Runtime.OnInit(function()
 {
  ...
  Next=Runtime.Safe(UI.Next);
  Var=Runtime.Safe(Next.Var);
  _3nyildarts=Runtime.Safe(Global._3nyildarts);
  Client=Runtime.Safe(_3nyildarts.Client);
  Var1=Runtime.Safe(Next.Var1);
  Unchecked=Runtime.Safe(Global.WebSharper.Unchecked);
  List=Runtime.Safe(Global.WebSharper.List);
  T=Runtime.Safe(List.T);
  ...
  Seq=Runtime.Safe(Global.WebSharper.Seq);
  ListModel=Runtime.Safe(Next.ListModel);
  return Strings=Runtime.Safe(Global.WebSharper.Strings);
 });
 Runtime.OnLoad(function()
 {
  Client.Res2();
